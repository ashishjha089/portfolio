import LovableAvatar from "./AshishAvatar";
    ...
    >
      ...
      <div className="flex-1 space-y-6 animate-fade-in">
        <h1 className="text-4xl md:text-5xl font-bold  mb-2 text-gray-800 tracking-wide ">
          Hey, I’m{" "}
          <span className="text-purple-600  gap-10">Ashishkumar Jha</span>!
        </h1>
        <p className="text-lg md:text-xl text-gray-600 max-w-lg mx-auto md:mx-0">
          Front-End Web Developer from India. I craft seamless, beautiful, and
          creative websites with expertise in React.js, Firebase, and Supabase.
          Passionate about user experience, I'm currently available for hire to
